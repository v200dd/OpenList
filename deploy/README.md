...
- Source: [OpenListTeam/OpenList-Worker](https://github.com/v200dd/OpenList-Worker)
...
| Goal | Use this |
| --- | --- |
| Full OpenList on the edge, with KV/Blob as the database | [OpenList-Worker](https://github.com/v200dd/OpenList-Worker) |
