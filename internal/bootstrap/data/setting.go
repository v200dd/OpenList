...
func InitialSettings() []model.SettingItem {
	...
	"epub": {
		...
		{Key: conf.EnableFileDownload, Value: "true", Type: conf.TypeBool, Group: model.GLOBAL, Flag: model.PUBLIC, Help: "hide download, copy link, QR code, and the same options in the context menu"},
